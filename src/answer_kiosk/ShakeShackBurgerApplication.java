...
public class ShakeShackBurgerApplication {
    ...
    private static void displayMainMenu() {
        ...
        List<Menu2> mainMenus = menuContext.getMenus("Main");	// 메뉴 컨텍스트에서 메인메뉴 조회
        int nextNum = printMenu(mainMenus, 1);					// 메인메뉴 출력

        System.out.println("[ ORDER MENU ]");
        List<Menu2> orderMenus = menuContext.getMenus("Order");	// 메뉴 컨텍스트에서 주문메뉴 조회
     ...
     * @return 출력 후 전체 순번
     */
    private static int printMenu(List<Menu2> menus, int num) {
     ...
     * @param menu 출력할 메뉴
     */
    private static void displayMenu(Menu2 menu) {
        System.out.println("SHAKESHACK BURGER 에 오신걸 환영합니다.");
    ...
    private static String getMenuName() {
        ...
        List<Menu2> mainMenus = menuContext.getMenus("Main");
